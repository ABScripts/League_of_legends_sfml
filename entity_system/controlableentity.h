...
public:
  ...
  virtual void mouseMoved(const sf::Time &time, const sf::Vector2f &mousePosition) = 0;
  virtual void mousePressed(const sf::Time &time, const sf::Vector2f &mousePosition) = 0;
