...
DISTFILES += \
    ...
    SFML/lib/sfml-audio-2.dll \
    SFML/lib/sfml-audio-d-2.dll \
    SFML/lib/sfml-graphics-2.dll \
    SFML/lib/sfml-graphics-d-2.dll \
    SFML/lib/sfml-network-2.dll \
    SFML/lib/sfml-network-d-2.dll \
    SFML/lib/sfml-system-2.dll \
    SFML/lib/sfml-system-d-2.dll \
    SFML/lib/sfml-window-2.dll \
    SFML/lib/sfml-window-d-2.dll
